...
import VistaStoricoOperatore from "@/components/VistaStoricoOperatore";

export const dynamic = "force-dynamic";

export default async function StoricoOperatorePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-6 px-4">
      ...
      <p className="text-sm mb-5" style={{ color: "var(--color-grey-mid)" }}>
        Storico ore per operatore
      </p>
      <OreSubNav active="storico-operatore" />
      <VistaStoricoOperatore />
    </div>
  );
}
