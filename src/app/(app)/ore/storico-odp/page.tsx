...
import VistaStoricoOdp from "@/components/VistaStoricoOdp";

export const dynamic = "force-dynamic";

export default async function StoricoOdpPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-6 px-4">
      ...
      <p className="text-sm mb-5" style={{ color: "var(--color-grey-mid)" }}>
        Storico ore per commessa/ODP
      </p>
      <OreSubNav active="storico-odp" />
      <VistaStoricoOdp />
    </div>
  );
}
