...
import VistaStoricoArticolo from "@/components/VistaStoricoArticolo";

export const dynamic = "force-dynamic";

export default async function StoricoArticoloPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-6 px-4">
      ...
      <p className="text-sm mb-5" style={{ color: "var(--color-grey-mid)" }}>
        Storico ore per codice articolo, su tutti gli ODP attivi
      </p>
      <OreSubNav active="storico-articolo" />
      <VistaStoricoArticolo />
    </div>
  );
}
