...
export default async function FerramentaPage() {
  ...
  // Kit Commessa, quindi lo mandiamo dritto lì invece di mostrargli questa pagina.
  if (!FERRAMENTA_ROLES.includes(session.role)) redirect("/ferramenta/kit-commessa");
