...
const inputCls = "rounded-lg border px-2 py-1.5 text-base bg-white focus:outline-none focus:ring-2 focus:ring-orange-300 w-32";
...
export default function CostoManodoperaForm({ costoIniziale }: { costoIniziale: number }) {
  ...
  return (
    <div className="rounded-xl border p-4" style={{ borderColor: "#e5e4e0" }}>
      <h2 className="text-base font-semibold mb-1" style={{ color: "var(--color-black)" }}>Costo orario manodopera</h2>
      ...
      <div className="flex items-center gap-3">
        ...
        />
        <span className="text-base" style={{ color: "var(--color-grey-mid)" }}>€/h</span>
        <button
