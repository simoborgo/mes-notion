  ...
  return (
    <div className="rounded-xl border p-4 space-y-4" style={{ borderColor: "#e5e4e0" }}>
      <div className="flex items-start justify-between gap-4">
        <div>
          <h2 className="text-sm font-semibold" style={{ color: "var(--color-black)" }}>Personale (da Notion)</h2>
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        {erroreToggle && <span className="text-xs font-medium" style={{ color: "#991B1B" }}>{erroreToggle}</span>}
      </div>
      ...
      <div className="rounded-lg border overflow-x-auto" style={{ borderColor: "#e5e4e0" }}>
        <table className="text-sm w-full">
          ...
          <tbody>
            ...
            {filtrati.length === 0 && (
              <tr><td colSpan={7} className="text-center py-6 text-xs" style={{ color: "var(--color-grey-mid)" }}>Nessun operatore trovato</td></tr>
            )}
          </tbody>
        </table>
      </div>
